...
__commonjs = {
  1(exports) {
    ...
    (function(scope) {
      ...
      var $author$project$Derive$Util$nodeValue = $stil4m$elm_syntax$Elm$Syntax$Node$value;
      var $author$project$Derive$Util$derivedModuleName = function(file) {
        return _Utils_ap($stil4m$elm_syntax$Elm$Syntax$Module$moduleName($author$project$Derive$Util$nodeValue(file.moduleDefinition)), _List_fromArray(["Derive"]));
      };
        ...
        switch (delaration.$) {
          ...
          case "CustomTypeDeclaration":
            ...
            var body = A2($elm$core$Result$map, function(cases) {
              ...
              return $the_sett$elm_syntax_dsl$Elm$CodeGen$apply(_List_fromArray([A2($the_sett$elm_syntax_dsl$Elm$CodeGen$fqVal, _List_fromArray(["Json", "Decode"]), "andThen"), $the_sett$elm_syntax_dsl$Elm$CodeGen$parens(A2($the_sett$elm_syntax_dsl$Elm$CodeGen$lambda, _List_fromArray([$the_sett$elm_syntax_dsl$Elm$CodeGen$varPattern("tag")]), caseExpression)), $the_sett$elm_syntax_dsl$Elm$CodeGen$parens($the_sett$elm_syntax_dsl$Elm$CodeGen$apply(_List_fromArray([A2($the_sett$elm_syntax_dsl$Elm$CodeGen$fqVal, _List_fromArray(["Json", "Decode"]), "field"), $the_sett$elm_syntax_dsl$Elm$CodeGen$string("$"), A2($the_sett$elm_syntax_dsl$Elm$CodeGen$fqVal, _List_fromArray(["Json", "Decode"]), "string")])))]));
            }, caseExpressions);
            var ann = A3($the_sett$elm_syntax_dsl$Elm$CodeGen$fqTyped, _List_fromArray(["Json", "Decode"]), "Decoder", _List_fromArray([A3($the_sett$elm_syntax_dsl$Elm$CodeGen$fqTyped, _List_Nil, $author$project$Derive$Util$nodeValue(customTypeDecl.name), _List_Nil)]));
            return A2($elm$core$Result$map, function(b) {
              return _List_fromArray([A5($the_sett$elm_syntax_dsl$Elm$CodeGen$funDecl, $elm$core$Maybe$Nothing, $elm$core$Maybe$Just(ann), "decode" + $author$project$Derive$Util$nodeValue(customTypeDecl.name), _List_Nil, b)]);
            }, body);
          default:
            return $elm$core$Result$Ok(_List_Nil);
        }
...
`
      ...
      var $author$project$Derive$generate = F2(function(_v0, file) {
        ...
        var html = _v0.html;
        var ord = _v0.ord;
        var libs = A2($elm$core$List$filterMap, $elm$core$Basics$identity, _List_fromArray([encode ? $elm$core$Maybe$Just($author$project$Derive$libEncode) : $elm$core$Maybe$Nothing, decode ? $elm$core$Maybe$Just($author$project$Derive$libDecode) : $elm$core$Maybe$Nothing, random ? $elm$core$Maybe$Just($author$project$Derive$libRandom) : $elm$core$Maybe$Nothing, html ? $elm$core$Maybe$Just($author$project$Derive$libHtml) : $elm$core$Maybe$Nothing, ord ? $elm$core$Maybe$Just($author$project$Derive$libCompare) : $elm$core$Maybe$Nothing]));
        var template = A2($elm$core$String$join, "\n\n", _List_fromArray(["module Template exposing (..)", A2($elm$core$String$join, "\n\n", A2($elm$core$List$map, function($) {
          return $.source;
        }, libs))]));
        var _v1 = $the_sett$elm_syntax_dsl$Elm$DSLParser$parse(template);
        if (_v1.$ === "Err") {
      ...
      var $author$project$Main$update = F2(function(msg, model) {
        ...
        var _v1 = $stil4m$elm_syntax$Elm$Parser$parse(source);
        if (_v1.$ === "Err") {
          var err = _v1.a;
          ...
          if ($elm$core$Dict$isEmpty(model_.requestingFiles)) {
            ...
            if (_v2.$ === "Nothing") {
              ...
              var file = A2($stil4m$elm_syntax$Elm$Processing$process, $stil4m$elm_syntax$Elm$Processing$init, targetRawFile);
